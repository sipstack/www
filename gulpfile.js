...
function res_kb_articles(cb) {
  src([
    'src_content/resources/knowledge-base/api/**/index.json',
    'src_content/resources/knowledge-base/api/**/index.jsonc',
  ])
    .pipe(
      fileinclude({
        prefix: '@@',
  ...
  src([
    'src_content/resources/knowledge-base/text-messaging/**/index.json',
    'src_content/resources/knowledge-base/text-messaging/**/index.jsonc',
  ])
    .pipe(
      fileinclude({
        prefix: '@@',
  ...
  src([
    'src_content/resources/knowledge-base/fax/**/index.json',
    'src_content/resources/knowledge-base/fax/**/index.jsonc',
  ])
    .pipe(
      fileinclude({
        prefix: '@@',
  ...
  src([
    'src_content/resources/knowledge-base/regulatory/**/index.json',
    'src_content/resources/knowledge-base/regulatory/**/index.jsonc',
  ])
    .pipe(
      fileinclude({
        prefix: '@@',
  ...
  src([
    'src_content/resources/knowledge-base/phone-number/**/index.json',
    'src_content/resources/knowledge-base/phone-number/**/index.jsonc',
  ])
    .pipe(
      fileinclude({
        prefix: '@@',

	...
	regularPlans: [
		{
			...
			price: "Free",
			priceLabel: "Forever",
			features: ["Additional capacity not available", "Free for personal/non commercial projects"],
		},
		{
			name: "Starter",
			...
			features: ["Additional capacity starts at $10/mo", "Entry level plan running tests and projects"],
		},
		{
			name: "Pro",
			...
			price: "$299/mo",
			priceLabel: "Starting at",
			features: ["Additional capacity starts at $5/mo", "Includes online support and app integrations"],
		},
	],
	premiumPlan: {
		name: "Enterprise",
...
export const pricingBlockPlans = [
	...
	},
	{
		...
		monthlyPrice: 32,
		yearlyPrice: 350,
		features: ["5 users", "2 Dashboard", "Project Module", "Accounting Module", "CRM Module", "--"],
	},
	{
		name: "Executive",
		text: "Discover our premium features for 30 days , absolutely free",
		monthlyPrice: 55,
		yearlyPrice: 490,
		features: ["15 users", "3 Dashboards", "Project Module", "Accounting Module", "CRM Module", "Helpdesk module"],
	},
	{
		name: "Enterprise",
		text: "Discover our premium features for 30 days , absolutely free",
		monthlyPrice: 90,
		yearlyPrice: 790,
		features: ["30 users", "Unlimited Dashboards", "Access to all modules", "Integrations", "Dedicated support", "Beta features"],
	},
];
	...
	personalPlans: [
		{
			...
			planText: "Jumpstart your business by conducting small marketing campaigns",
			buttonLabel: "Get Started Now",
			features: ["Send one campaign per month", "Maintain one subscriber list", "Max of 20 new leads per month"],
		},
		{
			...
			planText: "Gain more power and increase your marketing and lead generation",
			buttonLabel: "Choose Freelancer",
			features: ["Send 3 campaigns per month", "Maintain 3 subscriber lists", "Max of 100 new leads per month"],
		},
		{
			...
			price: 15,
			priceBilling: "Per month",
			planText: "The best choice to boost your internal marketing and lead generation",
			buttonLabel: "Upgrade Now",
			features: ["Send unlimited campaigns", "Maintain unlimited subscriber lists", "Unlimited new leads per month"],
		},
	],
	premiumPlans: [
		{
			...
			name: "Business",
			price: 45,
			priceBilling: "Price per month and per team member. Includes a team owner and 2 team members.",
			planText: "For established companies with specific needs and internal teams. Estimate your pricing.",
			buttonLabel: "Schedule Demo",
			features: ["Includes everything from Personal", "Projects and team management", "Internal team messaging"],
			highlight: {
		...
		},
		{
			...
			name: "Enterprise",
			price: 75,
			priceBilling: "Price per month and per team member. Includes a team owner and 6 team members.",
			planText: "For bigger and comlpex companies with multiple teams and departments. Estimate your pricing.",
			buttonLabel: "Schedule Demo",
			features: ["Includes everything from Business", "Manage multi tenant organizations", "Professional and customized reports"],
			highlight: {
		...
		},
		{
			...
			name: "Custom",
			price: 99,
			priceBilling: "Contact us to discuss planning of your business needs and your project scope.",
			planText: "Get everything from the Enterprise plan and ask for personalized implementations and development.",
			buttonLabel: "Schedule Demo",
			features: ["Includes everything from Enterprise", "Custom features and implementations", "Personalized software integrations"],
			highlight: {
				title: "On-Demand training",
				subtitle: "Our solution experts will come to your office for a training session",
...
export const pricingCompactPlans = [
	{
		name: "Basic",
		description: "For individuals who just need to start with the basic features",
		monthlyPrice: 0,
		yearlyPrice: 0,
	...
	{
		name: "Pro",
		description: "For medium businesses who need advanced features for their activity",
		monthlyPrice: 15,
		yearlyPrice: 149,
		actionLabel: "Start Free Trial",
		popular: false,
	...
	{
		name: "Enterprise",
		description: "For large businesses who need advanced features for their activity",
		monthlyPrice: 99,
		yearlyPrice: 899,
...
export const pricingDuoPlans = [
	{
		...
		features: ["Git connector", "Integrations", "Single sign on", "500GB upload /year", "Live Chat"],
		featured: false,
	},
	{
		name: "Enterprise",
		...
		features: ["All team features", "File processing", "Bulk uploads", "24/7 support", "Search API"],
		featured: false,
	},
];

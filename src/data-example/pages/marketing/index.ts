...
export const tabbedProcess = {
	steps: [
		...
		},
		{
			...
			content: "Optimize your keywords for sales growth and profitability. Automatically capture new converting keywords while negating ones that are hurting performance.",
		},
		{
			id: 3,
			icon: "/assets/icons/abstract/4.svg",
			title: "Custom Analytics",
			content: "Track progress to your goals. Understand your total business performance with individual and combined product, campaign, and profitability metrics.",
		},
	],
	images: [
		{
...
export const testimonials = [
	{
		...
		content: "Vulk software is notably robust, and their analysts have helped us both maximize profitability and truly understand the incremental value of our web Ads.",
	},
	{
		id: 1,
		customer: {
		...
		content: "Not only are our metrics and performance up and exceeding expectations, but I’ve been really impressed with the way that they manage our business.",
	},
	{
		id: 2,
		customer: {
		...
		content: "Vulk has definitely made the management of our web advertising better. By combining the convenience of managing keywords and bids, along with being able to.",
	},
	{
		id: 3,
		customer: {
		...
		content: "Bringing on Vulk has been a tremendous asset to our web business. NatureWise’s sales velocity has increased substantially, and we’re excited to.",
	},
	{
		id: 4,
		customer: {
	...
	},
	{
		...
		content: "Once you see the algorithm in action, you see how awesome Vulk and their technology really are! I can't wait to get back working on my project!",
	},
	{
		id: 7,
		customer: {
	...
	},
	{
		...
		content: "Vulk came in with a very clear perspective on how to drive brand growth on web, powerful AI systems and a strong managed services team.",
	},
];
...
export const testimonialsMarquee = [
	...
	},
	{
		...
		logo: "/assets/brands/phasekit.svg",
		content: "Within three months of starting with Vulk, we had our best month ever in terms of both profits and sales.",
	},
	{
		id: 5,
		customer: {
	...
	},
	{
		...
		logo: "/assets/brands/proactive.svg",
		content: "Once you see the algorithm in action, you see how awesome Vulk and their technology really are!",
	},
	{
		id: 7,
		customer: {

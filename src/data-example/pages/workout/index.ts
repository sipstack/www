...
export const workoutPricingPlans = [
	{
		...
		features: ["Premium programs", "Social integration", "Social network", "2h of coaching /month", "Live Events"],
		featured: false,
	},
	{
		name: "Premium",
		...
		features: ["Custom programs", "Live streaming", "Personal page", "10h of coaching /month", "VIP invites"],
		featured: false,
	},
];

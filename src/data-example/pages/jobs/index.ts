...
export const jobs: Job[] = [
	{
		...
		content: {
			...
			aptitude: [
				{
					title: "Skills",
					skills: [`Bachelor degree in computer programming`, `5+ years experience in software engineering`, `Felling confident in micro-service environments`],
				},
				{
					title: "Bonus Skills",
					skills: [`Strong english redaction, tech writer`, `Google GCP, Amazon AWS or Azure provider`, `A little experience on online game app`],
				},
				{
					title: "Soft Skills",
					skills: [`Autonomous and self-taught`, `Business oriented vision`, `Technical teaching skills`],
				},
			],
			technologies: [
				{
	...
	},
	{
		...
		duration: "Fulltime",
		salary: "$55k - $65k annual",
		contact: "mailto:careers@vulk.cssninja.io?subject=senior-solution-architect",
		content: {
			description: [
				{
					title: `About us`,
	...
	},
	{
		...
		duration: "Fulltime",
		salary: "$45k - $55k annual",
		contact: "mailto:careers@vulk.cssninja.io?subject=senior-fullstack-developer",
		content: {
			description: [
				{
					title: `About us`,

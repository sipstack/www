export const posts = [
  {
    ...
    image:
      '/assets/img/resources/blog/20230119-fcc-proposes-record-high-300m-fine-for-auto-warranty-robocalls/fccfine.png',
    category: 'Scams',
    tags: ['SIPSTACK', 'FCC', 'Regulatory'],
    views: 0,
    title: "FCC Proposes Record-High $300M Fine for Auto Warranty' Robocalls",
    abstract:
      'The Federal Communications Commission has proposed a $300 million fine against two Californian men responsible for an auto warranty robocall campaign, the largest penalty ever proposed by the agency over robocalls.',
    ...
    content: `
Last month, the Federal Communications Commission proposed a $300 million fine against two Californian men responsible for an auto warranty robocall campaign. This is the latest government action against telecommunications fraud and the largest penalty ever proposed by the agency over robocalls. 
...
`,
...

  {
    ...
    image:
      '/assets/img/resources/blog/20230117-988-crtc-introduces-three-digit-code-for-mental-health-crises-and-suicide-prevention/suicide.png',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title:
    ...
    abstract:
      '988 is a three-digit code introduced by the CRTC for mental health crises and suicide prevention services, as part of Telecom Regulatory Policy 2022-234 (TRP 2022-234).',
...
`,
  ...
  {
    slug: 'the-growing-risk-of-veteran-charity-phone-scams',
    image:
      '/assets/img/resources/blog/20230113-the-growing-risk-of-veteran-charity-phone-scams/veteranscam.png',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'The Growing Risk of Veteran Charity Phone Scams',
    abstract:
      'Veteran charity phone scams refer to scammers who pose as charities for war veterans and solicit donations via phone calls under this false pretense.',
    created: '13/01/2023', //dd/mm/yyyy
    updated: '',
...
![ftc](/assets/img/resources/blog/20230113-the-growing-risk-of-veteran-charity-phone-scams/ftctip.png)
...
`,
  ...
  {
    slug: 'the-fcc-proposed-rules-and-initiatives-to-combat-robotexts',
    image:
      '/assets/img/resources/blog/20230112-the-fcc-proposed-rules-and-initiatives-to-combat-robotexts/v4-blog-legal-sign.jpeg',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: "The FCC's Proposed Rules and Initiatives to Combat Robotexts",
    abstract:
      'The FCC recently sought comment on proposed rules to prevent illegal robotexts.',
    created: '12/01/2023', //dd/mm/yyyy
    updated: '',
    duration: 2, // minute read
    author: {
      name: 'Jeff Sager',
...
`,
  ...
  {
    slug: "what-to-do-if-you've-been-scammed",
    image:
      "/assets/img/resources/blog/20230104-what-to-do-if-you've-been-scammed/scamphoto.png",
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: "What To Do If You've Been Scammed",
    abstract:
      "Here are some of the measures we recommend taking if you or a loved one suspect you've been scammed.",
    created: '04/01/2023', //dd/mm/yyyy
    updated: '',
    duration: 2, // minute read
    author: {
      name: 'Jeff Sager',
...
`,
  ...
  {
    slug: 'the-growing-risk-of-sms-scams',
    image:
      '/assets/img/resources/blog/20221229-the-growing-risk-of-sms-scams/unhappy-woman-look-cell-screen-crying.jpg',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'The Growing Risk of SMS Scams',
    abstract:
      'SMS scams refer to messages that pretend to be sent from either a personal or business contact, prompting the recipient to click a fraudulent URL link, which will result in their personal details being tracked.',
    created: '29/12/2022', //dd/mm/yyyy
    updated: '',
...
`,
  ...
  {
    slug: 'ho-ho-holiday-scams',
    image:
      '/assets/img/resources/blog/20221213-ho-ho-holiday-scams/holiday-scam.png',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'Ho Ho Holiday Scams',
    abstract:
...
`,
  ...
  {
    slug: 'how-scam-affects-different-age-groups',
    image:
      '/assets/img/resources/blog/20221209-how-scam-affects-different-age-groups/diffages.png',
    category: 'SCAMS',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'How Scam Affects Different Age Groups',
    abstract:
      'It is a common misconception that seniors are disproportionate victims and targets of fraud. Fraud affects every generation differently.',
    created: '10/12/2022', //dd/mm/yyyy
    updated: '',
    duration: 5, // minute read
    author: {
...
![graph1](/assets/img/resources/blog/20221209-how-scam-affects-different-age-groups/graph1.png)  
...
![graph2](/assets/img/resources/blog/20221209-how-scam-affects-different-age-groups/graph2.png)   
<sup>Source: FTC Consumer Sentinel Network </sup>
...
`,
...

  {
    ...
    tags: ['SIPSTACK'],
    views: 0,
    title: 'The Growing Risk of Friendship and Romance Scams',
    abstract:
      'Friendship and romance scams refer to scammers who create fake profiles on dating apps, social media platforms, or other online communities with the intention of forming an online relationship with their victims.',
...
`,
  ...
  {
    slug: 'the-growing-risk-of-the-grandparent-scam-in-canada',
    image:
      '/assets/img/resources/blog/20221123-the-growing-risk-of-the-grandparent-scam-in-canada/confused-grandparents.png',
    category: 'Scams',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'The Growing Risk of the Grandparent Scam in Canada',
    abstract:
      'The Grandparent Scam refers to scammers who call senior citizens, pretending to be their grandchild in an emergency crisis.',
    created: '23/11/2022', //dd/mm/yyyy
    updated: '',
    duration: 5, // minute read
    author: {
      name: 'Jeff Sager',
    ...
    content: `
As telecommunication fraud continues to grow exponentially, with reported losses in 2021 of $383 million in [Canada](https://www.sipstack.com/resources/blog/the-state-of-spam-calling-in-canada)<sup>1</sup> and $30 billion in the [United States](https://www.sipstack.com/resources/blog/the-state-of-spam-calling-in-the-US)<sup>2</sup>, it's never been more important to stay informed. There are several different types of spam calling and texting scams that have contributed to these losses. One that has already seen 13,293 reported cases, 7,322 victims, and over $118 million of losses for Ontario residents in 2022 alone, is known as the "Grandparent Scam"<sup>3</sup>.
...
`,
  ...
  {
    slug: 'How-covid-19-has-impacted-fraud',
    image:
      '/assets/img/resources/blog/20221122-how-covid-19-has-impacted-fraud/covid-19-blog.png',
    category: 'Fraud',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'How Covid-19 Has Impacted Fraud',
    abstract:
      'In the wake of Covid-19, businesses around the world were forced to quickly adapt to the new reality the pandemic had brought in 2020.',
    created: '22/11/2022', //dd/mm/yyyy
    updated: '',
    duration: 5, // minute read
    author: {
      name: 'Anjana Uthayakumaran',
...
`,
...

  {
    ...
    views: 0,
    title:
      "CRTC Hosts 'Combating Scam Communications' Meeting with Five Countries",
    abstract:
      'On November 1st, 2022, the CRTC held its first cross-border meeting to discuss strategies to help combat the growing concerns of telecommunication fraud.',
    created: '11/11/2022', //dd/mm/yyyy
    updated: '',
    ...
    content: `
On November 1st, 2022, the CRTC held its first cross-border meeting to discuss strategies to help combat the growing concerns of telecommunication fraud. In addition to the Canadian hosts, the in-person meeting included regulators from Ireland, Hong Kong, Australia, and the United States. 
...
`,
  ...
  {
    slug: 'Landmark-settlement-in-Indiana-combats-robocalls',
    image:
      '/assets/img/resources/blog/20221029-landmark-settlement-in-Indiana-combats-robocalls/Indiana-image.png',
    category: 'News',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'Landmark Settlement in Indiana Combats Robocalls',
    abstract:
      'Attorney General Todd Rokita publicly announced his settlement on October 20th,  after a  yearlong battle against Startel Communications LLC and its CEO, Wanda Hall.',
    created: '31/10/2022', //dd/mm/yyyy
    updated: '',
...
`,
  ...
  {
    slug: 'the-state-of-spam-calling-in-the-US',
    image:
      '/assets/img/resources/blog/20221020-the-state-of-telecommunications-spam-in-the-US/issue-50.svg',
    category: 'Spam',
    tags: ['SIPSTACK'],
    views: 0,
    title: 'The State of Telecommunications Spam in the United States',
    abstract:

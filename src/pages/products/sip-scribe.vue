...
import { pageLinks, features, faq } from '/@src/data/products/sip-scribe'
</script>
...
<template>
  <div>
    <ssHeroProducts
      title="SIP Scribe"
      subtitle="Transcribe voice with ease"
    ...
    <Section id="overview">
      <Container>
        <SectionTitle
          title="Drop in voice transcription &#8212; that works"
          subtitle="Overview" />

        <ssSubscriptionCompactBlock
          text="Simple voice to text transcription service designed for ITSP's. Simple drop in API calls in your call routes to return transcribed messages. Offer your customers enhanced user experiences with transcribed voicemails and call recordings."
    ...
    <Section id="features" color="grey">
      <Container>
        <SectionTitle title="Plug & play transcription" subtitle="Features" />

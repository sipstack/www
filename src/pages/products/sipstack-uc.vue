...
import {
  ...
  features,
  faq,
} from '../../data/products/sipstack-uc'
...
<template>
  <div>
      ...
      <Container>
        <ssSideSection
          ...
          <template #content>
            <QuickFeatures
              class="mt-4"
              :features="['Multi-brand', 'Multi-tenant', 'Self-hosted']" />
          </template>
        </ssSideSection>
      </Container>
    </Section>
    ...
    <Section id="features" color="grey">
      <Container>
        <SectionTitle
          title="Asterisk trusted, AI/ML augmented"
          subtitle="Features" />
    ...
    <Section color="grey">
      <Container>
        <ssCtaDefault
          ...
          subtitle="Request your access to a limited preview" />
      </Container>
    </Section>

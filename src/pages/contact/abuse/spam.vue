...
<template>
  <SsHeroSimple
    title="Report Spam"
    subtitle="Spam is Unsolicited Bulk Email distributed to recipients who have not provided direct consent." />
      ...
      <container>
        <form>
          <div class="columns is-multiline">
            ...
            <div class="column is-12">
              <Field>
                <FieldLabel label="First Name">Message Body</FieldLabel>
                <Control>
                  <VTextarea :rows="4" placeholder="" />
                </Control>
              </Field>
            ...
            <div class="column is-12">
              <Field>
                <FieldLabel label="First Name">Spamvertisement URLs</FieldLabel>
                <Control>
                  <VTextarea :rows="4" placeholder="" />
                </Control>
              </Field>
            ...
            <div class="column is-6">
              <Field>
                <FieldLabel label="First Name">Digital Signature</FieldLabel>

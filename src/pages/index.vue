...
<template>
  <div>
    ...
    <Section color="grey">
      <Container>
        ...
        <div class="video-player-container-wrapper pb-6">
          <Player
            ratio="16by9"
            source="https://www.youtube.com/embed/H8Hx_1lLh2E?start=20&autoplay=1&mute=1&controls=0&rel=0&fs=0"
    ...
    <FooterCC
      text="Better telecommunications through AI"
      color="dark"

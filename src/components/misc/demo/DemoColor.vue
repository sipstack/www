	...
	<div class="color-card">
		...
		<div v-if="isOpen">
			...
			<div class="color-picker">
				<ColorPicker :id="props.color" class="hide-alpha hide-copy" :color="`hsl(${colorHueVar}, ${colorSaturationVar}, ${colorLuminanceVar})`" @color-change="updateColor">
					...
					<template #copy-button>
						...
						<i class="iconify is-clickable" aria-hidden="true" data-icon="feather:copy"></i>
					</template>

					<template #format-switch-button>
						<span class="sr-only">Switch format</span>

						<i class="iconify rem-120 is-clickable" aria-hidden="true" data-icon="fluent:chevron-up-down-20-filled"></i>
					</template>
				</ColorPicker>
			</div>
			<div class="is-divider"></div>

...
export type PluginColor = "default" | "primary" | "info" | "success" | "warning" | "danger" | "purple" | "yellow" | "orange" | "green" | "red" | "blue";
...
<template>
	<div class="plugin-grid">
		<div class="columns is-multiline">
			<div v-for="(item, index) in props.items" :key="index" class="column is-4">
				<div class="grid-item">

		...
		<div class="tabs is-boxed">
			<ul>
				<li :class="activeTab === 'code' ? 'is-active' : ''">
					<a @click.prevent="activeTab = 'code'" @keydown.space.prevent="() => (activeTab = 'code')">
						<i class="iconify rem-90" data-icon="feather:code"></i>
						<span class="ml-1">Code</span>
					</a>
				</li>
				<li :class="activeTab === 'props' ? 'is-active' : ''">
					<a @click.prevent="activeTab = 'props'" @keydown.space.prevent="() => (activeTab = 'props')">
						<span>Props</span>
					</a>
				</li>
				<li :class="activeTab === 'sample' ? 'is-active' : ''">
					<a @click.prevent="activeTab = 'sample'" @keydown.space.prevent="() => (activeTab = 'sample')">
						<span>Sample</span>
					</a>
				</li>
				<li :class="activeTab === 'usage' ? 'is-active' : ''">
					<a @click.prevent="activeTab = 'usage'" @keydown.space.prevent="() => (activeTab = 'usage')">
						<span>Info</span>
					</a>
				</li>
			</ul>

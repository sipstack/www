	...
	<div class="demo-features pt-12 pb-6">
		<div class="columns b-columns-half-tablet-p">
			<div class="column is-5">
				<!--Feature-->
				<div v-for="(feature, index) in props.features" :key="index" class="demo-feature-wrapper">
			...
			<div class="column is-7">
				<img v-if="!darkmode.isDark" class="long-screenshot" src="/assets/screenshots/vulk-page-1.png" alt="Long screenshot" />
				<img v-else class="long-screenshot" src="/assets/screenshots/vulk-page-1-dark.png" alt="Long screenshot" />
			</div>
		</div>
	</div>
</template>

...
const style = computed(() => (darkmode.isDark ? "mapbox://styles/mapbox/dark-v10" : "mapbox://styles/mapbox/light-v10"));
...
<template>
	<div ref="container" class="map" :class="props.absolute && 'is-absolute'"></div>
</template>

...
export type TongueOneColor = "grey" | "darker" | "primary" | "white" | "footer-dark";
...
<template>
	<svg width="853" height="639" viewBox="0 0 853 639" fill="none" xmlns="http://www.w3.org/2000/svg" class="tongue-1" :class="svgClasses">
		<path
			fill-rule="evenodd"
			clip-rule="evenodd"

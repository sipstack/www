	...
	<form>
		<div class="login-form">
			...
			<div class="setting-item">
				<Checkbox v-model="options" color="primary" name="checkbox-1" label="I have read the Terms of Service" value="terms" />
			</div>

			<Control class="mt-4">
				<Button color="primary" fullwidth bold raised>Sign Up</Button>
			</Control>
		</div>
	</form>
</template>

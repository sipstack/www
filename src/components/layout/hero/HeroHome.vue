...
<template>
  <Hero
    ...
    alignment="left"
    size="fullheight"
    shape="/assets/img/hero-shape-ss-k.svg"
      ...
      <div class="columns is-vcentered">
        <div class="column is-5">
          ...
          <Subtitle tag="p" :size="5" classes="b-centered-tablet-p text-medium">
            Machine learning & community sourced data drives our Unified
            Communications platform and suite of tools, bringing real-time
            information to the forefront of connecting people.
          </Subtitle>
          <!--Buttons-->
        ...
        <div class="column is-7 is-offset-1">
          ...
          <DarkImage
            ...
            alt="SIPSTACK HUB | Dashboard"
            width="1519"
            height="949"
          />
        </div>
      </div>
      <!-- <NumbersSection :numbers="mentorStats" animated /> -->
    </template>
    <!-- <template #footer>
      <div class="seen-on mx-auto max-w-8">

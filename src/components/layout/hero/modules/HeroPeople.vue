	...
	<div class="hero-people-marquee">
		<MarqueeText :repeat="10" :duration="40">
			<div class="hero-people-list">
				<div v-for="(person, index) in props.people" :key="index" class="hero-people-item">
					...
					<div class="has-text-centered pt-2">
						...
						<div class="bottom-row">
							...
							<div class="rating">
								<i v-if="person.rating >= 1" class="iconify" data-icon="uiw:star-on"></i>
								<i v-if="person.rating >= 2" class="iconify" data-icon="uiw:star-on"></i>
								<i v-if="person.rating >= 3" class="iconify" data-icon="uiw:star-on"></i>
								<i v-if="person.rating >= 4" class="iconify" data-icon="uiw:star-on"></i>
								<i v-if="person.rating === 5" class="iconify" data-icon="uiw:star-on"></i>
							</div>
						</div>
					</div>
				</div>

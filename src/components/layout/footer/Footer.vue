...
const footerClasses = computed(() => [props.color && `footer-${props.color}`, props.content.cta && `has-cta`]);
</script>
	...
	<footer class="footer" :class="footerClasses">
		...
		<div class="container">
			<div class="columns footer-columns is-bordered pt-4 pb-6">
				<div v-for="(column, index) in props.content.columns" :key="index" class="column is-one-fifth">
					<div class="footer-column">
						<Subtitle :size="6" weight="thin" tag="h4" leading inverted uppercase>
				...
				<div class="column is-one-fifth has-text-centered">
					<div class="social-block">
						...
						<div class="socials">
							<RouterLink v-for="(social, s) in props.content.socials" :key="s" class="footer-link" :to="social.link">
								<i class="iconify" :data-icon="social.icon" data-inline="false"></i>
			...
			<div class="columns is-vcentered pt-6 pb-6">
				<div class="column is-8">
					<div class="is-flex d-column-mobile d-column-tablet-p is-align-items-center">
						<a class="footer-logo-left" href="#">
							<img class="small:mx-auto large:mx-0" src="/assets/logo/logo.svg" alt="logo" />
							<span class="footer-logo-text">Vulk</span>
						</a>
						<ul class="py-2">
							<li v-for="(link, l) in content.links" :key="l" class="inline-block px-2">
				...
				<div class="column is-4 has-text-centered">
					<p class="paragraph medium:text-right is-6" data-config-id="copyright">
						{{ content.copyright }}
					</p>
				</div>
			</div>

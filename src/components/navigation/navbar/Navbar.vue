...
<template>
	<nav
		...
		:class="[isScrolled && 'is-scrolled', isNavbarOpen && 'is-solid', isMegamenuOpen && 'is-solid', props.inverted && 'is-inverted', props.solid && 'is-solid']"
		...
		<div class="container">
			<div class="navbar-brand">
				<RouterLink v-preload-link class="navbar-item" to="/">
					<img class="navbar-logo" src="/assets/logo/logo.svg" alt="logo" width="80" height="80" />
				</RouterLink>
			...
			<div class="navbar-menu b-centered-mobile b-centered-tablet-p" :class="[isNavbarOpen && 'is-active']">
				<div class="navbar-start">
					<a
						role="button"
						class="navbar-item"
						:class="[activeDropdown === 'products-drop' && 'is-selected']"
						tabindex="0"
						@mouseover="() => selectMobileMenu('products-drop')"
						@focusin="() => selectMobileMenu('products-drop')"
					>
						<span class="has-naver mr-1">Products</span>
            ...
            <span class="has-naver mr-1">Solutions</span>
				...
				<div class="navbar-end">
					...
					<div class="navbar-item">
						<Button href="/signup" target="_blank" color="primary" raised bold> Get Started </Button>
					</div>
				</div>
			</div>
		</div>

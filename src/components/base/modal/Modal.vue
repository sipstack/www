...
<template>
	<teleport to="body">
		<div :class="[open && 'is-active', size && `is-${size}`]" class="modal v-modal">
			<div class="modal-background v-modal-close" @click="() => noclose === false && emit('close')" @keydown.space.prevent="() => noclose === false && emit('close')"></div>
			<div class="modal-content">
				<div class="modal-card">
					...
					<div class="modal-card-foot" :class="[actions === 'center' && 'is-centered', actions === 'right' && 'is-end']">
						<slot name="cancel">
							<Button raised :long="2" :rounded="rounded" @click="emit('close')" @keydown.space.prevent="() => emit('close')"> Cancel </Button>
						</slot>

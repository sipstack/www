...
export type ImageRatio = "1by1" | "5by4" | "4by3" | "3by2" | "5by3" | "16by9" | "2by1" | "3by1" | "4by5" | "3by4" | "2by3" | "3by5" | "9by16" | "1by2" | "1by3";
...
const ratioClasses = computed(() => [
	...
	props.ratio === "1by1" && props.squareDimensions && `is-${props.squareDimensions}x${props.squareDimensions}`,

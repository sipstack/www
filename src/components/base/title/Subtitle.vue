...
<template inherit-attrs="false">
	<h3 v-if="tag == 'h3'" v-bind="$attrs" class="subtitle" :class="subtitleClasses">
		<slot></slot>
	</h3>

	<h4 v-if="tag == 'h4'" v-bind="$attrs" class="subtitle" :class="subtitleClasses">
		<slot></slot>
	</h4>

	<p v-if="tag == 'p'" v-bind="$attrs" class="subtitle" :class="subtitleClasses">
		<slot></slot>
	</p>
</template>

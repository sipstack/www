...
const blockClasses = computed(() => [props.aligned && "is-aligned", props.leading && "is-leading"]);

const subtitleClasses = computed(() => [props.inverted ? `text-white` : "text-gradient"]);
...
<template>
	<div class="page-title" :class="blockClasses">
		<Subtitle tag="h3" :size="5" weight="bold" :inverted="props.inverted" class="m-0 pb-5">

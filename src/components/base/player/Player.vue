...
<template>
	<div class="video-player-container" :class="[ratio && 'is-' + ratio, reversed && 'reversed-play']">
		<!-- video element -->
		<iframe v-if="embed" :src="`${props.source}`" :title="props.title" allowfullscreen allowtransparency allow="autoplay"></iframe>

		<video v-else ref="videoElement" controls crossorigin="anonymous" playsinline :data-poster="props.poster" autoplay muted>
			<source :src="source" type="video/mp4" />
			<track v-for="(caption, key) in props.captions" :key="key" :default="caption.default" kind="captions" :srclang="caption.srclang" :src="caption.src" />
		</video>
	</div>
</template>

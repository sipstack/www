...
export type RadioColor = "default" | "primary" | "success" | "info" | "warning" | "danger";
	...
	<div class="radio" :class="radioClasses">
		<label :for="`radio-${props.group}`" class="radio-inner-wrap">
			<span class="radio-inner">
				<input :id="`radio-${props.group}`" :name="props.name" :checked="checked" :value="props.value" type="radio" @change="change" />

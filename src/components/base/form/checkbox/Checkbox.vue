...
export type CheckboxColor = "default" | "primary" | "success" | "info" | "warning" | "danger";
...
const checkboxClasses = computed(() => [props.color && `is-${props.color}`, props.rounded && `is-rounded`]);
</script>
	...
	<div class="checkbox" :class="checkboxClasses">
		<label :for="`checkbox-${props.name}`" class="checkbox-inner-wrap">
			<span class="checkbox-inner">
				<input :id="`checkbox-${props.name}`" :value="props.value" :checked="checked" type="checkbox" @change="change" />

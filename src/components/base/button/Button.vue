...
export type ButtonColor = "primary" | "secondary" | "default" | "info" | "success" | "warning" | "danger" | "light" | "dark";
...
<template>
	<RouterLink v-if="props.to" :to="props.to" class="button" :class="buttonClasses">
		<i v-if="props.iconLeft" class="iconify mr-1" :data-icon="props.iconLeft"></i>
		<slot></slot>
		<i v-if="props.iconRight" class="iconify ml-2" :data-icon="props.iconRight"></i>
	</RouterLink>
	<a v-else-if="props.href" :href="props.href" class="button" :class="buttonClasses">
		<i v-if="props.iconLeft" class="iconify mr-1" :data-icon="props.iconLeft"></i>
		<slot></slot>
		<i v-if="props.iconRight" class="iconify ml-2" :data-icon="props.iconRight"></i>
	</a>
	<button v-else class="button" :class="buttonClasses" :disabled="props.disabled">
		<i v-if="props.iconLeft" class="iconify mr-1" :data-icon="props.iconLeft"></i>
		<slot></slot>
		<i v-if="props.iconRight" class="iconify ml-2" :data-icon="props.iconRight"></i>
	</button>

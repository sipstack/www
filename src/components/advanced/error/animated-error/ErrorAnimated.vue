		...
		<div class="error-wrapper">
			...
			<div class="error-content">
				...
				<p class="paragraph rem-115 is-inverted-light mx-auto max-w-4 mb-4">
					<slot> Oops, something went wrong and we couldn't find that page. Please try again later. </slot>
				</p>
				<Buttons alignment="centered">
					<Button to="/" :long="3" color="light" outlined bold>Homepage</Button>
					<Button :long="3" color="light" outlined bold @click.prevent="$router.back()" @keydown.space.prevent="() => $router.back()"> Back </Button>
				</Buttons>
			</div>
		</div>
	</div>

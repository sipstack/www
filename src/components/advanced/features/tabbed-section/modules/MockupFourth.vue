		...
		<div class="chart" :class="[props.loaded && 'loaded']">
			<svg viewBox="0 0 560 260">
				...
				<g class="datasets">
					...
					/>
					<path id="dataset-2" class="dataset" d="M0,260 C35,254 63,124 88,124 C114,124 148,163 219,163 C290,163 315,100 359,100 C402,100 520,244 560,259 C560,259 0,259 0,260 Z" />
					<path
						id="dataset-1"
						class="dataset"
...
.chart {
	...
	background-image: repeating-radial-gradient(center center, var(--dot-color), var(--dot-color) 2px, transparent 2px, transparent 100%);

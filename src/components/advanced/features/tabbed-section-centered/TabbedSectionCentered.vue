	...
	<div class="py-6">
		<div class="centered-tabbed-section">
			<div class="section-tabs">
				<a class="tab-item" :class="activeTab === 'tab1' && 'is-active'" @click.prevent="activeTab = 'tab1'" @keydown.space.prevent="() => (activeTab = `tab1`)"> Discussions </a>
				<a class="tab-item" :class="activeTab === 'tab2' && 'is-active'" @click.prevent="activeTab = 'tab2'" @keydown.space.prevent="() => (activeTab = `tab2`)">
					Private Spaces
				</a>
				<a class="tab-item" :class="activeTab === 'tab3' && 'is-active'" @click.prevent="activeTab = 'tab3'" @keydown.space.prevent="() => (activeTab = `tab3`)">
					Personal Reports
				</a>
			</div>
				...
				<transition name="fade-slow" mode="out-in">
					<div v-if="activeTab === 'tab1'" class="tab-inner">
						<p class="paragraph mb-4">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Zenonis est, inquam, hoc Stoici. Neutrum vero, inquit ille. Immo alio genere; Mihi enim satis est, ipsis non

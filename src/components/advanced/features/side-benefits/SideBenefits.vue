...
const sideBenefitsClasses = computed(() => [props.bordered && `is-bordered`, props.inverted && `is-inverted`, props.reverse && `is-reverse`]);

const textClasses = computed(() => [props.inverted && `is-inverted`]);
</script>

<template>
	<div class="side-benefits mobile:py-0 small:py-6 z-1" :class="sideBenefitsClasses">
		<div class="columns is-vcentered">
			<div class="column is-5">
				...
				<div v-for="(benefit, index) in props.benefits" :key="index" class="benefit mb-2">

...
<template>
	<div class="py-6 mx-auto max-w-9">
		<div class="columns is-multiline b-columns-half-tablet-p">
			<div v-for="(feature, index) in props.features.slice(0, props.limit)" :key="index" class="column">
				<div class="box has-text-centered" :class="boxClasses">
					<slot name="column" :feature="feature" :index="index">
						<div class="pulse-image-wrapper">
							<DarkImage :src="feature.image" :src-dark="feature.darkImage" class="pulse-image" alt="featured image" width="100" height="100" />
						</div>

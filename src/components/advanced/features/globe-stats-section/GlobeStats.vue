    ...
    <div class="globe-stats">
      <div class="globe-holder">
        <div class="globe-inner">
          <Globe :size="1080" :map-samples="11098.83" />
        </div>
      </div>
      <div class="stats-block">
        <div class="stat-block">
          <div class="block-inner">
            ...
            <p class="paragraph is-upper">Countries</p>
          </div>
        </div>
        <div class="stat-block">
          <div class="block-inner">
            ...
            <p class="paragraph is-upper">Running Servers</p>
          </div>
        </div>
        <div class="stat-block">
          <div class="block-inner">
            ...
            <p class="paragraph is-upper">Data Served</p>
          </div>
        </div>
        <div class="stat-block">
          <div class="block-inner">
            ...
            <p class="paragraph is-upper">Customers</p>
          </div>
        </div>
      </div>
    </div>

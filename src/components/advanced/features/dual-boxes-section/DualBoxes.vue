					...
					<div class="dual-box box-solid">
						...
						<div class="inner-box">
							<div class="action-list">
								<p class="paragraph mb-4">Select a Git provider to import an existing project from a Git Repository.</p>
								<div class="button-list">
									<Button to="/" color="dark" icon-left="fa:github" fullwidth> Continue with GitHub </Button>
									<Button to="/" color="secondary" icon-left="fa:gitlab" fullwidth> Continue with Gitlab </Button>
									<Button to="/" color="primary" icon-left="ion:logo-bitbucket" fullwidth> Continue with Bitbucket </Button>
								</div>
							</div>
						</div>
					...
					<div class="dual-box box-muted">
						...
						<div class="inner-box">
							<div class="columns is-multiline b-columns-half-tablet-p">
								<div v-for="(template, index) in props.templates.slice(0, 4)" :key="index" class="column is-6">
									<RouterLink :to="template.link" class="template-box">
										<DarkImage :src="template.image" alt="template image" width="400" height="300" />

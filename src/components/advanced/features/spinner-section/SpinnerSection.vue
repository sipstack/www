...
const spinnerSectionClasses = computed(() => [props.bordered && `is-bordered`, props.inverted && `is-inverted`, props.reverse && `is-reverse`]);
	...
	<div class="side-section py-6 z-1" :class="spinnerSectionClasses">
		<div class="columns is-vcentered">
			...
			<div class="column is-6 is-offset-1 has-text-centered is-relative">
				...
				<Title v-if="props.legend" tag="h3" :size="5" weight="bold" class="text-white">
					{{ props.legend }}
				</Title>
				<div class="spinner-container">
					<img class="is-relative spinner-base is-block mx-auto" :src="props.image" alt="spinner layer" :width="props.imageWidth" :height="props.imageHeight" />
					<img

		...
		<div class="stacked-section">
			<div class="columns is-vcentered b-columns-half-tablet-p">
				<div class="column is-5 is-offset-1">
					<div v-for="(feature, index) in props.features.slice(0, 3)" :key="index" class="media max-w-4">
						<div class="media-left">
							<IconBox :color="feature.color" size="medium" :rounded="props.rounded" :inverted="props.inverted">
				...
				<div class="column is-6">
					<div class="color-box">
						...
						<div class="character">
							<DarkImage :src="props.image" :src-dark="props.darkImage" alt="Featured Image" :width="props.imageWidth" :height="props.imageHeight" />
						</div>
					</div>
				</div>
			</div>

	...
	<div class="testimonials-grid py-6">
		...
		<div class="testimonials-grid-inner">
			<div class="columns is-multiline b-columns-half-tablet-p">
				<div v-for="(testimonial, index) in props.testimonials" :key="index" class="column is-4">
					<div class="box">
						<div class="head">
							...
							<img class="logo" :src="testimonial.logo" alt="testimonial logo" width="300" height="113" />
						</div>
						<div class="body">

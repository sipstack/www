	...
	<div class="py-6">
		<div class="testimonials-carousel">
			<div class="testimonials-carousel-title max-w-7 mb-6">
				<Subtitle tag="h3" :size="6" weight="bold" class="pb-2" :inverted="props.inverted">
					<span :class="!props.inverted && 'text-gradient'"> A home for your business </span>
				</Subtitle>
				<Title tag="h2" :size="3" weight="bold" :inverted="props.inverted">
					<span>Join your fellow creators</span>
				</Title>
				<p class="paragraph rem-115" :class="props.inverted && 'is-inverted-light'">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quamquam te quidem video minime esse deterritum. Quae cum dixisset, finem ille cum dolor.
				</p>
			</div>

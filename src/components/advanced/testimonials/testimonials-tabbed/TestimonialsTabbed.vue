		...
		>
			<template #tab="{ activeValue }">
				<div v-if="activeValue === 'trainees'">
					<div class="tabbed-grid">
						<div class="columns is-multiline">
							<div v-for="(trainee, t) in props.trainees" :key="t" class="column is-6">
								<div class="tabbed-grid-item">
									<Tag label="Customer Stories" class="mb-4" />
									<Title tag="h3" :size="6" weight="semi"> "{{ trainee.title }}" </Title>
									<p class="paragraph rem-90 mb-4">{{ trainee.content }}</p>
									<div class="member">
										<AvatarSimple :picture="trainee.member.picture" size="medium" squared />
										<div class="meta">
				...
				<div v-else-if="activeValue === 'mentors'">
					<div class="tabbed-grid">
						<div class="columns is-multiline">
							<div v-for="(mentor, m) in props.mentors" :key="m" class="column is-6">
								<div class="tabbed-grid-item">
									<Tag label="Mentor Stories" class="mb-4" />
									<Title tag="h3" :size="6" weight="semi"> "{{ mentor.title }}" </Title>
									<p class="paragraph rem-90 mb-4">{{ mentor.content }}</p>
									<div class="member">
										<AvatarSimple :picture="mentor.member.picture" size="medium" squared />
										<div class="meta">
											<Title tag="h3" :size="7" weight="semi" narrow>
												{{ mentor.member.name }}
											</Title>

			...
			<div class="columns">
				<div class="column is-6 is-offset-3">
					...
					<div class="css-carousel">
						...
						<!-- Hidden inputs -->
						<input v-for="(slide, r) in props.slides" :id="`radio-${slide.id}`" :key="r" type="radio" name="slides" :checked="slide.id === 0" @change="activeSlide = slide.id" />
						<ul class="slides">
							<!-- Carousel item -->
						...
						<div class="carousel-dots">
							<label v-for="(slide, d) in props.slides" :id="`dot-for-radio-${slide.id}`" :key="d" :for="`radio-${slide.id}`"></label>
						</div>
					</div>
				</div>
			</div>

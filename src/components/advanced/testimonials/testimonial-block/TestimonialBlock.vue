...
<template>
	<div class="py-6">
		<div class="columns is-vcentered b-columns-half-tablet-p" :class="columnsClasses">
			<div class="column is-6" :class="columnMediaClasses">
				<img class="testimonial-image" :src="props.image" alt="testifier image" @error.once="(event) => viaPlaceholderErrorHandler(event, '600x600')" />
			</div>

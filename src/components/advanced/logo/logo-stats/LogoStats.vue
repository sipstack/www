	...
	<div class="py-6">
		<div class="logo-stats">
			...
			<div class="clients" :class="invertedClasses">
				...
				<div class="right">
					<div class="columns is-vcentered is-multiline b-columns-half-mobile b-columns-half-tablet-p">
						<div v-for="(logo, index) in props.logos.slice(0, 6)" :key="index" class="column is-4">

				...
				<div class="slider-controls">
					<ul>
						<li v-for="(slide, l) in props.slides" :key="l">
							<a :class="activeSlide === l ? 'is-active' : ''" @click.prevent="activeSlide = l" @keydown.space.prevent="() => (activeSlide = l)">
				...
				<div class="slider-content">
					<div class="slider-panel">
						<div class="car-container">
							<div v-for="(slide, index) in props.slides" :key="index" class="car-container-inner" :class="activeSlide === index ? 'is-active' : ''">
								<img class="car-main-image" :src="slide.image" alt="car image" width="1000" height="485" />

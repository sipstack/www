				...
				<div class="column is-5 is-centered-mobile">
					...
					<div class="button-wrap">
						<div class="combo-button">
							<Button :class="!toggle && 'is-active'" @click="toggle = !toggle"> Monthly </Button>
							<Button :class="toggle && 'is-active'" @click="toggle = !toggle"> Yearly </Button>
						</div>
					</div>
				</div>
				<!-- Pricing card -->
				<div v-for="(plan, index) in props.plans.slice(0, 2)" :key="index" class="column">
					...
					<div class="pricing-card" :class="cardClasses">
						...
						<div v-if="!toggle">
							<div class="plan-price">
								<Title tag="h3" :size="4" weight="bold" narrow> ${{ plan.price.monthly.toFixed(2) }} </Title>
							</div>
							<div class="price-per">per month</div>
						</div>
						<div v-else>
							<div class="plan-price">
								<Title tag="h3" :size="4" weight="bold" narrow> ${{ plan.price.yearly.toFixed(2) }} </Title>
							</div>

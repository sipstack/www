...
<template>
	<div class="pricing-wrapper">
		...
		<div class="pricing-container" :class="activeTab === 0 && 'is-active'">
			<div class="container-inner">
				<div class="solo-plans">
					<!--Plan-->
					<div v-for="(plan, p) in props.personalPlans" :key="p" class="solo-plan">
						<div class="header">
							<img :src="plan.icon" alt="Pricing icon" />
							<span>{{ plan.name }}</span>
						</div>
		...
		<div v-for="(plan, s) in props.premiumPlans" :key="s" class="pricing-container" :class="activeTab === s + 1 && 'is-active'">
					...
					<div class="right-side">
						<div class="feature-highlight">
							...
							<div class="highlight-item">
								...
								<DarkImage class="highlight-image" :src="plan.highlight.image" :src-dark="plan.highlight.darkImage" alt="Feature highlight" image-width="668" image-height="454" />
							</div>
						</div>
					</div>
				</div>

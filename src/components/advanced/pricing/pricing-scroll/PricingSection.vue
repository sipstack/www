	...
	<div>
		<div class="billing-toggle">
			<NinjaToggle v-model="billing" name="billing_toggle" icon value="Yearly">
				<img class="text" src="/assets/illustrations/text/text-color.svg" alt="help text" />
			</NinjaToggle>
		</div>
		<div class="side-pricing">
			...
			<div class="plan-details">
				...
				<div v-for="(plan, index) in props.plans" :key="index" class="plan-details-inner" :class="[activeSection === index && 'is-active']">
					<div class="inner">
						<h3>Benefits</h3>
						<div class="feature-list">
							<div v-for="(benefit, b) in plan.benefits" :key="b" class="feature-list-item">
								<div class="dot">
									<div class="dot-inner">
					...
					<div class="inner">
						...
						<div class="feature-list is-last">
							<div v-for="(feature, f) in plan.features" :key="f" class="feature-list-item is-feature">
								<div class="dot">
									<div class="dot-inner">
										<i class="iconify" data-icon="feather:check"></i>
									</div>
				...
				<div class="button-wrap pt-5">
					<Button color="primary" elevated bold fullwidth> Start your Free Trial </Button>
				</div>
			</div>
		</div>
	</div>

	...
	<div class="py-6">
		<div class="pricing-long mx-auto" :class="blockClasses">
			...
			<div class="columns b-columns-half-tablet-p">
				<div v-for="(plan, index) in props.plans.slice(0, props.limit)" :key="index" class="column" :class="columnClasses">
					<div class="pricing-long-card">
						<div class="pricing-long-card-header" :class="plan.color && `is-${plan.color}`">
							...
							<div class="pricing-price">
								...
								<p class="paragraph rem-95 is-inverted-light">per user, per month</p>
							</div>
						</div>

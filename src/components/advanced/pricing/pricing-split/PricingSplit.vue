		...
		<div class="split-card">
			...
			>
				<div class="split-card-head">
					...
					<p class="paragraph is-inverted-light">Feature-rich options at business scale</p>
				</div>
				<div class="split-card-body">
					<div class="right-plan">
						...
						<div class="plan-features">
							<div v-for="(item, i) in props.premiumPlan.features.slice(0, 4)" :key="i" class="plan-feature">
								<h3>{{ item.title }}</h3>
								<p>
									{{ item.text }}
								</p>

		...
		<div class="pricing-solo-head">
			<div class="billing-selector">
				<div class="billing-selector-inner">
					<button :class="activePricing === 'monthly' && 'is-active'" @click="activePricing = 'monthly'">Monthly Billing</button>
					<button :class="activePricing === 'yearly' && 'is-active'" @click="activePricing = 'yearly'">Annual Billing</button>
					<div class="naver"></div>
				</div>
			</div>
		</div>

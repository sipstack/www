		...
		<div class="pricing-action max-w-4 mx-auto">
			<div class="pricing-action-box">
				...
				<div class="pricing-action-box-inner">
					...
					<div class="meta">
						<Title tag="h3" :size="5" weight="semi" narrow> ${{ props.monthlyPrice }}/month </Title>
						<p class="paragraph rem-90">${{ props.quarterlyPrice }} paid quarterly</p>
					</div>
				</div>
			</div>
			<div class="pricing-action-box">
			...
			<div class="button-wrap">
				<Button color="primary" size="medium" fullwidth raised> Create an Account </Button>
			</div>
		</div>
	</div>
</template>

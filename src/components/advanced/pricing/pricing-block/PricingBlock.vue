...
<template>
	<div class="pricing-block">
		<div class="billing-switcher-wrapper">
			<div class="by-month" :class="billing.length > 0 ? '' : 'is-active'">Monthly</div>
			<div class="billing-switcher">
				<NinjaToggle v-model="billing" name="pricing-toggle" flavor="switch" color="primary" value="Yearly" />
			</div>
		...
		<div class="pricing-wrapper">
			<div class="pricing-card">
				<div class="columns is-gapless b-columns-half-tablet-p">
					<!-- Plan -->
					<div v-for="(plan, index) in props.plans.slice(0, 4)" :key="index" class="column is-3">
						<div class="condensed-plan">
							...
							<div class="plan-price">
								...
								<div v-if="billing.length > 0" class="yearly-billed">(Billed at ${{ plan.yearlyPrice }}/year)</div>
								<div v-else class="monthly-billed">(Billed at ${{ plan.monthlyPrice }}/month)</div>
							</div>
			...
			<img class="hr-bg" src="/assets/shapes/pricing-blob.svg" alt="background shape" width="1096" height="824" />
		</div>
	</div>
</template>

...
<template>
	<div class="company-values mx-auto max-w-10">
		<div class="columns b-columns-third-tablet-p">
			<div v-for="(value, index) in props.values" :key="index" class="column is-4">
				<div class="company-value has-text-centered">
					<DarkImage class="mx-auto light-image-block" :src="value.image" :src-dark="value.darkImage" alt="Illustration" />

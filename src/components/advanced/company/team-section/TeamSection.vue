...
<template>
	<div class="mx-auto max-w-9 pb-6">
		<div class="columns is-multiline b-columns-third-tablet-p">
			<div v-for="(member, index) in props.members" :key="index" class="column is-3">
				<div class="team-member">
					...
					<div class="meta-info">
						...
						<div class="right">
							<a v-for="(profile, p) in member.socialProfiles" :key="p" :href="profile.url" target="_blank" class="social-profile">

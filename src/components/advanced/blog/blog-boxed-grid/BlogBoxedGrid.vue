		...
		<div class="blog-boxed-grid" :class="props.inverted && 'is-inverted'">
			...
			<div class="inner-grid">
				<div class="columns is-multiline">
					<div v-for="(post, index) in props.posts" :key="index" class="column is-6">
						<RouterLink to="/" class="boxed-post">
							<div class="post-image">
								<img :src="post.image" alt="Featured image" width="600" height="337" @error.once="(event) => viaPlaceholderErrorHandler(event, `600x337`)" />
							</div>
							<div class="post-body">

...
<template>
	<div class="blog-recent-posts">
		...
		<div class="blog-recent-posts-inner">
			<RouterLink v-for="(post, index) in props.posts.slice(0, props.limit)" :key="index" to="/blog/post" class="blog-recent-post">
				...
				<div class="post-content">
					...
					<div class="meta">
						<Tags>
							<Tag v-for="(category, c) in post.categories" :key="c" :label="category.name" />
						</Tags>
					</div>
				</div>
			</RouterLink>

			...
			<Container>
				<div class="columns is-vcentered">
					<div class="column is-5">
						<div class="form-card">
							<div class="auth-head">
								<Title tag="h2" :size="3" weight="thin" narrow> Welcome Back </Title>
								<RouterLink to="/auth/signup-3" class="rem-90"> I do not have an account yet </RouterLink>
							</div>
							<LoginForm />
						</div>
						<div class="forgot-link has-text-centered">
							<RouterLink to="/auth/signup-3">Forgot Password?</RouterLink>
						</div>
					</div>

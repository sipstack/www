	...
	<div class="py-6">
		<div class="nft-grid" :class="blockClasses">
			...
			<div class="grid-inner">
				<TransitionGroup name="list" tag="div" class="columns is-multiline b-columns-half-tablet-p b-columns-third-tablet-l">
					<div v-for="(item, index) in props.items" :key="index" class="column" :class="columnClasses">

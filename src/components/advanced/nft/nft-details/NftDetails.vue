...
const countDown = new Date(Date.now() + randomDays * (3600 * 1000 * 24)).getTime();
				...
				<div class="column is-6">
					<div class="nft-info">
						...
						<div class="nft-info-price">
							<span class="eth-price text-gradient"> {{ props.nft.initialBid.eth }} ETH </span>
							<span class="paragraph px-1">·</span>
							<span class="dollar-price"> (${{ props.nft.initialBid.dollar }}) </span>
							<span class="paragraph px-1">·</span>
							<span class="collection-rank"> 1 of {{ props.nft.collection.items }} </span>
						</div>
									...
									<template #tab="{ activeValue }">
										<div v-if="activeValue === 'bids'">
											<div class="active-bids">
												<div v-for="(bider, index) in props.nft.biders" :key="index" class="active-bid">
											...
											<div class="current-bid">
												<div class="highest-bid">
													...
													<span class="highest-bid-value">
														<span class="highest-bid-eth text-gradient"> {{ props.nft.currentBid.eth }} ETH </span>
														<span class="highest-bid-dollar"> (${{ props.nft.currentBid.dollar }}) </span>
													</span>
												</div>
										...
										<div v-else-if="activeValue === 'comments'">
											<div v-if="props.nft.comments">
												...
												<div v-else>
													<div class="py-4">
														<PlaceholderSection title="No Comments" subtitle="Looks like there are no comments on this item for now.">
															<template #image>
																<i-ph-chat-circle-dots-duotone class="text-primary rem-175" />
															</template>
														</PlaceholderSection>
													</div>
												</div>

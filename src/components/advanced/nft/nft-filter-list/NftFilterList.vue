					...
					<div class="py-6">
						<div class="nft-list-filters-inner">
							<div class="mb-5">
								...
								<Control>
									<Slider v-model="priceValue" :min="0" :max="1" :step="-1" show-tooltip="drag" />
							...
							<div class="mb-5">
								...
								<Control>
									<VSelect v-model="statusSelect" :options="statusOptions" placeholder="All" />
								</Control>
							</div>
							...
							<div class="mb-5">
								...
								<Control>
									<VSelect v-model="raritySelect" :options="rarityOptions" placeholder="All" />
								</Control>
							</div>
							...
							<div class="mb-5">
								...
								<Control>
									<VSelect v-model="themeSelect" :options="themeOptions" placeholder="All" />
								</Control>
							</div>

							<div>
								<Button fullwidth bold @click="resetFilters"> Reset Filters </Button>
							</div>
						</div>
					</div>
				</div>

		...
		<div class="contact-info" :class="blockClasses">
			...
			<div class="contact-info-card">
				<div class="columns b-columns-half-tablet-p">
					<div v-for="(info, index) in props.infos.slice(0, props.limit)" :key="index" class="column" :class="columnClasses">
						<i class="iconify" :data-icon="info.icon" :class="`text-${info.color}`"></i>

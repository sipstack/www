...
<template>
	<Transition name="from-bottom">
		<Card v-if="offlineReady || needRefresh" class="pwa-toast" role="alert" radius="smooth">
			...
			<Buttons>
				<Button v-if="needRefresh" color="primary" icon="ion:reload-outline" :loading="loading" raised @click="() => update()">
					{{ t("reload-button") }}
				</Button>

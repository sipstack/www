...
const footerClasses = computed(() => [props.color && `footer-${props.color}`, props.bubbles && "footer-overflow"]);
</script>
			...
			<div class="columns is-vcentered">
				<div class="column is-8">
					<div class="is-flex d-column-mobile d-column-tablet-p is-align-items-center">
						<RouterLink :to="{ name: 'index' }" class="footer-logo-left css-ninja mobile:mb-4">
							<img class="small:mx-auto large:mx-0 size-44x44" src="/assets/logo/logo.svg" alt="footer logo" />
							<span class="is-sr-only">Logo</span>
						</RouterLink>
						<ul class="link-list p-2">
							<slot name="links">
								<li class="inline-block px-2">
									<RouterLink :to="{ name: 'index' }" class="footer-link"> Features </RouterLink>
								</li>
								<li class="inline-block px-2">
									<RouterLink :to="{ name: 'index' }" class="footer-link"> About </RouterLink>
								</li>
								<li class="inline-block px-2">
									<RouterLink :to="{ name: 'index' }" class="footer-link"> Support </RouterLink>
								</li>
								<li class="inline-block px-2">
									<RouterLink :to="{ name: 'index' }" class="footer-link"> Contact </RouterLink>
								</li>
							</slot>
						</ul>
					</div>
				...
				<div class="column is-4 has-text-centered">
					<p class="paragraph rem-90 footer-text medium:text-right is-6" data-config-id="copyright">

...
<template>
	<footer class="footer" :class="footerClasses">
		...
		<div class="container footer-inner">
			<div class="columns is-multiline">
					...
					<div class="columns is-flex-tablet is-flex-mobile">
						<div class="column is-4">
							<div class="footer-group">
								<slot name="column-1">
									<Title tag="h3" :size="6" weight="thin" :inverted="props.color === 'dark'">
										<span>Discover</span>
									</Title>
									<ul class="link-list">
										<li>
				...
				<div class="column is-4 b-centered-mobile b-centered-tablet-p">
					<div class="footer-group">
						<a class="is-flex j-center-mobile j-center-tablet-p footer-logo-left css-ninja" href="#">
							<img class="size-44x44" src="/assets/logo/logo.svg" alt="Footer logo" />
						...
						<div class="level is-mobile py-4 max-w-1 small:mx-auto">
							<RouterLink v-for="(link, index) in props.socialLinks" :key="index" class="level-item footer-link" :to="link.url">
								<span class="icon">
		...
		<div class="container copyright pt-12">
			<div class="is-flex is-align-items-center is-justify-content-space-between d-column-r-mobile d-column-r-tablet-p">
				<div class="py-4">
				...
				<div class="has-text-centered">
					<Field grouped>
						<Control icon="feather:mail" expanded>
							<VInput placeholder="Email Address" :inverted="props.color === 'dark'" />
						</Control>
						<Control>

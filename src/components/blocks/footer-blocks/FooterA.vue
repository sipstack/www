			...
			<div class="columns is-vcentered b-flex-tablet-p">
				...
				<div class="column is-4 has-text-centered">
					<RouterLink class="footer-logo-centered" :to="{ name: 'index' }">
						<img class="is-block size-44x44" src="/assets/logo/logo.svg" alt="Footer logo" />
						<span class="is-sr-only">Logo</span>
					</RouterLink>
					<div v-if="props.socialLinks" class="level is-mobile py-4 mx-auto max-w-1">
						<RouterLink v-for="(link, index) in props.socialLinks" :key="index" :to="link.url" class="level-item footer-link">
							<span class="icon">

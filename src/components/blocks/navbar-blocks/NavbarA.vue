...
<template>
	<nav class="navbar is-transparent" :class="navbarClasses">
		<div class="container">
			...
			<div class="navbar-menu b-centered-mobile b-centered-tablet-p" :class="navbarMenuClasses">
				<div class="navbar-start">
					<RouterLink :to="{ name: 'index' }" class="navbar-item has-naver"> Features </RouterLink>
					<RouterLink :to="{ name: 'index' }" class="navbar-item has-naver"> Pricing </RouterLink>
					<RouterLink :to="{ name: 'index' }" class="navbar-item has-naver"> About </RouterLink>
					<NavbarDropdown label="Company" :boxed="props.dropdownBoxed">
						<RouterLink :to="{ name: 'index' }" class="navbar-item"> About </RouterLink>
						<RouterLink :to="{ name: 'index' }" class="navbar-item"> Jobs </RouterLink>
						<RouterLink :to="{ name: 'index' }" class="navbar-item"> Contact </RouterLink>
						<hr class="navbar-divider" />
						<RouterLink :to="{ name: 'index' }" class="navbar-item"> Report an issue </RouterLink>
					</NavbarDropdown>
				</div>
				<div class="navbar-end">
					...
					<RouterLink :to="{ name: 'index' }" class="navbar-item has-naver"> Login </RouterLink>

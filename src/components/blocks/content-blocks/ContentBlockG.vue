    ...
    <div class="columns is-vcentered b-columns-half-tablet-p">
      <div class="column is-5">
        <slot name="content">
          ...
          <div
            class="is-flex is-align-items-center py-4 small:mx-auto small:max-w-4 j-center-tablet-p j-center-mobile"
          >
            <img
      ...
      <div class="column is-7">
        <slot name="images">
          <div
            class="columns is-multiline image-columns b-columns-half-mobile b-only-tablet-p-flex"
          >
            <div

		...
		<div class="columns is-vcentered b-columns-half-tablet-p">
			<div class="column is-6">
				<slot name="content">
					...
					<ActionLink v-if="props.link" :label="props.linkLabel" :link="props.link" size="small" />
				</slot>
			</div>
			<div class="column is-6">
				<slot name="images">
					<div class="mx-auto is-flex is-justify-content-center is-flex-wrap-wrap">
						<div v-for="(image, index) in props.images.slice(0, 10)" :key="index" class="image-wrap">

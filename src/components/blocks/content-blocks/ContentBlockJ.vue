	...
	<div class="py-6 mx-auto max-w-10">
		<div class="columns is-vcentered b-only-tablet-p-flex">
			<div class="column is-6">
				<Title tag="h2" :size="4" weight="semi" leading :inverted="props.inverted">
					<span>{{ props.title }}</span>
				</Title>
				<p class="paragraph">{{ props.text }}</p>

				<div class="py-4">
					<div class="columns b-flex-mobile b-columns-third-tablet-p is-multiline m-0 has-text-centered">
						<div v-for="(counter, index) in props.counters" :key="index" class="column is-4">
							<div class="counter-icon">
								<i class="iconify" :data-icon="counter.icon"></i>
							</div>
							<div class="pb-4">
								<Title tag="h3" :size="4" weight="bold" narrow :inverted="props.inverted">

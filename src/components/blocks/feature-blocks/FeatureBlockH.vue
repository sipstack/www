...
const textClasses = computed(() => [props.columns != 6 && "max-w-3 rem-80", props.columns === 6 && "max-w-4 rem-90", props.inverted && "text-light"]);
</script>
		...
		<div class="columns is-multiline b-columns-half-tablet-p">
			<div v-for="(feature, index) in props.features.slice(0, props.limit)" :key="index" class="column" :class="columnClasses">
				<div class="is-flex items-start py-4">
					<IconBox :color="feature.color" size="small" :rounded="props.rounded" :inverted="props.inverted">

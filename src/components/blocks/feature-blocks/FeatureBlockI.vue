...
const textClasses = computed(() => [props.columns != 6 && "rem-90", props.columns === 6 && "rem-95", props.inverted && "text-light"]);
</script>
...
<template>
	<div class="py-6">
		<slot name="title">
			<div class="pb-6">
				<Title tag="h2" :size="3" weight="bold" leading :inverted="props.inverted">
		...
		<div class="columns is-multiline b-columns-half-tablet-p">
			<div v-for="(feature, index) in props.features.slice(0, props.limit)" :key="index" class="column mobile:mb-6" :class="columnClasses">
				<DarkImage :class="[...imageClasses]" :src="feature.image" :src-dark="feature.darkImage" alt="featured image" />
				<div>

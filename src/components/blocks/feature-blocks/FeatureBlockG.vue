		...
		<div class="columns is-multiline">
			<div class="column is-12">
				<div class="block mb-4 has-text-centered mx-auto max-w-8">
					<slot name="image">
						<DarkImage :src="props.image" :src-dark="props.darkImage" alt="featured image" />
					</slot>

					<div class="columns b-columns-third-tablet-p has-text-left mt-4">
						<slot name="features">
							<div v-for="(feature, index) in props.features.slice(0, 3)" :key="index" class="column is-4">
								<div class="media">
									<div class="media-left">
										<IconBox :color="feature.color" size="small" :inverted="props.inverted">

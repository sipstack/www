...
<template>
	<div class="py-6">
		<div v-for="(testimonial, index) in props.testimonials.slice(0, props.limit)" :key="index" class="testimonial-box max-w-7 mx-auto" :class="blockClasses">
			<div>
				<img class="testimonial-avatar small:mx-auto small:mb-4" :src="testimonial.avatar" alt="Testimonial image" />
			</div>

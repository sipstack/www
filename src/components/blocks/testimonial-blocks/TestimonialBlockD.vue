	...
	<div class="py-6">
		<div class="testimonials">
			<div class="columns is-multiline">
				<div v-for="(testimonial, index) in props.testimonials.slice(0, props.limit)" :key="index" class="column is-6">
					<div class="testimonial-box">
						<div class="testimonial-content">
							...
							<div class="social">
								<RouterLink v-for="(link, i) in testimonial.socialLinks" :key="i" :to="link.url" target="_blank" class="px-1">
						...
						<div class="image">
							<AvatarSimple size="xl" :picture="testimonial.avatar" :squared="props.squared" />
							<img class="testimonial-logo" :src="testimonial.logo" alt="company logo" />
						</div>
					</div>
				</div>
			</div>

...
const boxClasses = computed(() => [props.curved && "is-curved", props.reversed && "is-reversed"]);
</script>
	...
	<div class="py-6">
		<div class="testimonials-box mx-auto max-w-9" :class="boxClasses">
			<div class="testimonials-logo-setion">
				<img :src="props.image" alt="testimonial image" @error.once="(event) => viaPlaceholderErrorHandler(event, '500x333')" />
			</div>
			<div class="testimonials-story">
				<div class="testimonials-content">
					...
					<img v-if="props.logo" class="testimonial-logo" :src="props.logo" alt="company logo" />
				</div>
			</div>
		</div>
	</div>

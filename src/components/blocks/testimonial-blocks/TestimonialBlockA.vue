...
<template>
	<div class="py-6">
		<div class="testimonial-block columns b-columns-half-tablet-p is-multiline">
			<div v-for="(testimonial, index) in props.testimonials.slice(0, props.limit)" :key="index" class="column" :class="columnClasses">
				<div class="testimonial-block-item" :class="blockClasses">
					...
					<div class="level mt-4 mb-4">
						<div class="level-item">
							<AvatarSimple size="large" :picture="testimonial.avatar" :squared="props.squared" />
						</div>
					</div>

	...
	<div class="py-6">
		<div class="cta-block" :class="blockClasses">
			<div class="cta-content mx-auto max-w-4">
				<Title tag="h3" :size="3" weight="semi" :inverted="(props.boxed && props.color === 'primary') || props.color === 'darker' || props.inverted">
					<span>{{ props.title }}</span>
				</Title>

				<Subtitle tag="h3" :size="5" weight="thin" :inverted="(props.boxed && props.color === 'primary') || props.color === 'darker' || props.inverted" class="opacity-70">
			...
			<div v-if="props.ctaPrimary" class="buttons cta-content is-centered mt-5">
				...
				<Button v-if="props.ctaSecondary" color="light" :to="props.ctaPrimaryLink" :long="2" :outlined="props.color === 'primary' || props.color === 'darker'">
					{{ $props.ctaSecondary }}
				</Button>
			</div>

			<p v-if="props.logos.length > 0" class="cta-content paragraph rem-95 opacity-70 my-5" :class="textClasses">
				{{ props.logosText }}
			</p>
			<div v-if="props.logos.length > 0" class="cta-content mx-auto max-w-5 max-w-tablet-p max-w-tp-4">
				<div class="columns b-columns-half-mobile b-columns-third-tablet-p">
					<div v-for="(logo, index) in props.logos.slice(0, 5)" :key="index" class="column px-5">

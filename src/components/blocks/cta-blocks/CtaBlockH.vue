		...
		<div class="cta-block p-0 d-column-mobile">
			<div class="cta-content mobile:mb-6">
				<div color="cta-content-inner">
					<Subtitle tag="h4" :size="6" weight="bold" :inverted="props.inverted" narrow class="pb-5">
			...
			<div v-if="props.image && props.darkImage && !props.background" class="cta-image ml-auto">
				<DarkImage :src="props.image" :src-dark="props.darkImage" :width="props.imageWidth" :height="props.imageHeight" alt="Cta image" />
			</div>
			<div

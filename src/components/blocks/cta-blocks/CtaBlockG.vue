	...
	<div class="py-6">
		<div class="columns is-vcentered b-columns-half-tablet-p b-centered-mobile">
			<div class="column is-6">
				<div class="cta-block">
					<Title tag="h3" :size="3" weight="bold" leading :inverted="props.inverted">
			...
			<div class="column is-6">
				<DarkImage class="block mx-auto" :class="imageClasses" :src="props.image" :src-dark="props.darkImage" />
			</div>
		</div>
	</div>
</template>

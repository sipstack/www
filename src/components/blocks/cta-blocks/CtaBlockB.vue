				...
				<div class="cta-block mobile:mb-6" :class="blockClasses">
					<div class="cta-content">
						<Title
							...
							:size="4"
							weight="semi"
							:inverted="(props.boxed && props.color === 'primary') || props.color === 'darker' || (props.inverted && props.color === 'default')"
							leading
						>
							<span>{{ props.titlePrimary }}</span>
						</Title>
						<p class="paragraph mx-auto max-w-3 mb-4 opacity-70" :class="textClasses">
							{{ props.contentPrimary }}
						</p>
						<Buttons alignment="centered">
							<Button color="primary" :long="3" :to="props.ctaPrimaryLink" raised>
								{{ props.ctaPrimary }}
							</Button>
						</Buttons>
					</div>
			...
			<div class="column is-6">
				<div class="cta-block" :class="blockClasses">
					<div class="cta-content">
						...
						<Buttons alignment="centered">
							<Button color="light" :to="props.ctaSecondaryLink" :long="3" :outlined="props.color === 'primary' || props.color === 'darker'">
								{{ props.ctaSecondary }}
							</Button>
						</Buttons>
					</div>

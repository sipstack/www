...
const blockClasses = computed(() => [props.alignment === "centered" && `mx-auto has-text-centered`, props.alignment === "right" && `ml-auto`]);

const textClasses = computed(() => [props.alignment === "centered" && `mx-auto`, props.alignment === "right" && `ml-auto`]);
</script>
	...
	<div class="py-6">
		...
		>
			...
			<div class="cta-content" :class="blockClasses">
				...
				<p class="paragraph has-text-white rem-115 mb-4 max-w-4" :class="textClasses">
					{{ props.subtitle }}
				</p>

...
<template>
	<div class="py-6">
		<div class="columns is-multiline b-columns-half-mobile b-columns-third-tablet-p">
			<div v-for="(item, index) in props.items.slice(0, props.limit)" :key="index" class="column is-3" :class="columnClasses">
				<div class="team-block py-2">
					<Bubbles v-if="props.bubbles" />
					<AvatarSimple size="xl" :picture="item.image" :squared="props.squared" />
					<div class="py-2">

...
<template>
	<div class="team-block py-6" :class="blockClasses">
		<div class="columns is-multiline b-columns-half-tablet-p">
			<div v-for="(item, index) in props.items.slice(0, props.limit)" :key="index" class="column is-4">
				<div class="team-block-item media is-align-items-center mb-8">
					...
					<div class="media-content ml-2">
						...
						<div class="is-flex">
							<RouterLink v-for="(link, i) in item.socialLinks" :key="i" :to="link.url" target="_blank" class="mr-2">

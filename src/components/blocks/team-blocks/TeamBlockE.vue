				...
				<div class="team-block-item" :class="blockClasses">
					<div class="media is-align-items-center">
						<div class="media-left is-flex is-align-items-center">
							<AvatarSimple size="large" :picture="item.image" :squared="props.squared" />
						</div>
						<div class="media-content">
							...
							<div class="is-flex is-align-items-center">
								<RouterLink v-for="(link, i) in item.socialLinks" :key="i" :to="link.url" target="_blank" class="mr-2 rem-80">

    ...
    <div class="window-body">
      ...
      <div class="code-content">
        ...
        <div class="code-content-line">
          <span class="bold">same =>&nbsp;</span>
          n,Verbose(Getting Smart CNAM)
        </div>
        <div class="code-content-line">
          <span class="bold">same =>&nbsp;</span>
          n,Set(CALLERID(name)=${CURL(https://api.sipstack.com/v1/b/partner/smart-cnam/phoneNumber/
          <span class="bold">${CALLERID(num)}</span>
          /
          <span class="bold">${EXTEN}</span>
          ?type=cnam)})
        </div>
        <div class="code-content-line">
          <span class="bold">same =>&nbsp;</span>
          n,Verbose(Returns:
          <span class="bold">${CALLERID(name)}</span>
          ) ;
          <span class="bold text-secondary">RISK</span>
          <span class="bold text-primary">CALLERNAME</span>
          <small class="text-light pl-2">
            <em>(RISK and CNAM can be called independantly)</em>
          </small>
        </div>
        <div class="code-content-line">...</div>
      </div>

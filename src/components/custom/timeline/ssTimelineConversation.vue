...
<template>
	<div class="timeline-conversation">
		...
		<div class="conversation-message">
			<div class="message-text">
				<div class="message-box primary">
					<p>Here’s my deploy preview for the app update: https://shop-git-new-checkout.vercel.app</p>
				</div>
		...
		<div class="conversation-message">
			<div class="message-text">
				<div class="message-box primary">
					<p>This looks good. Can you double check that those issues we discussed were finally fixed?</p>
				</div>

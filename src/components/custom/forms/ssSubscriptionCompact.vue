...
import { ref } from "vue";
// import { testimonials } from "/@src/data-example/pages/banking";
...
<template>
	<div class="subscribe-compact">
		<form @submit.prevent="submit">
			<Field grouped>
				<Control expanded> <VInput v-model="f_email" name="email" :placeholder="props.placeholder" /> </Control>
				<Control>
					<Button size="form" color="primary" :long="1" raised bold>
						{{ props.label }}
					</Button>
				</Control>
			</Field>

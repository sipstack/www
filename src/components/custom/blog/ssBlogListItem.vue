...
<template>
	<div class="post-list-item" :class="blockClasses">
		<div v-if="!props.upsideDown" class="featured-post-image">
			<RouterLink :to="props.post.link">
				<img :src="props.post.image" alt="Featured image" width="360" height="200" @error.once="(event) => viaPlaceholderErrorHandler(event, `360x200`)" />
			</RouterLink>
			<div class="post-date">
		...
		<div class="featured-post-body">
			...
			<div class="post-action">
				<RouterLink :to="props.post.link" class="read-more-link">
					Read More
					<span>&#10230;</span>
				</RouterLink>
		...
		<div v-if="props.upsideDown" class="featured-post-image">
			<img :src="props.post.image" alt="Featured image" width="758" height="421" @error.once="(event) => viaPlaceholderErrorHandler(event, `758x421`)" />
			<div class="post-date">
				<div class="post-date-inner">
					<span>{{ props.post.date }}</span>
				</div>

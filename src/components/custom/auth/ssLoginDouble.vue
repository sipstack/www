...
const isSubmit = () => {
	...
	document.getElementById("description").innerHTML = "Your request has been received. <Br><Br>We will send you an email once your request has been approved.";
						...
						<div class="columns">
							<div class="column is-12">
								<div class="left-content">
									...
									<p>Welcome to the <b>SIPSTACK</b> Partner Portal</p>
									<br />
									<p>
										Registration currently limited to invite only.
										<br />
										Please complete the registration form to the right to create your SIPSTACK account. You will receive a welcome email upon review of information. Invitation
										requests could take up to 30 days to review while we are experiencing a very high volume of registrations.
									</p>
									<br />
						...
						<div class="columns">
							<div class="column is-12">
								<div class="auth-content">
									<Title id="title" tag="h2" :size="3" weight="thin" narrow> Get Started </Title>
									<p id="description">Please complete the form below</p>
								</div>
								<div id="form-div" class="auth-form-wrapper auth-content">
									<a href="https://hub.sipstack.com/"> I already have an account </a><br /><br />
									<form id="form" @submit.prevent>
										<div class="login-form">
											<Field>
												<FieldLabel label="Email" />
												<Control icon="feather:mail">
													<VInput v-model="email" name="email" placeholder="Email address..." />
												</Control>
											</Field>
											...
											<Field>
												...
												<Control icon="ion:business-outline">
													<VInput name="company" type="company" placeholder="Company name..." />
												</Control>
											</Field>
											<Field>
												<FieldLabel label="Company Phone Number" />
												<Control icon="ic:baseline-numbers">
													<VInput name="phone" type="phonenumber" placeholder="Company phone number..." />
												</Control>
											</Field>
											<Field>
												<FieldLabel label="Company Website" />
												<Control icon="iconoir:www">
													<VInput name="website" type="website" placeholder="Company website..." />
												</Control>
											</Field>

											<div class="setting-item">
												<Checkbox v-model="options" color="primary" name="tos" label="I agree to the Terms of Service" value="yes" />
											</div>

											<Control class="mt-4">
												<Button color="primary" fullwidth bold raised name="submit" @click="() => isSubmit()">Request Invite</Button>
											</Control>
										</div>
									</form>

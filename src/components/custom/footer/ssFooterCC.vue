              ...
              <div class="footer-group">
                <slot name="column-2">
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="https://github.com/sipstack/sipstack/discussions"
                        class="level-item footer-link"
                        target="_blank">
                        Forums
                      </a>
            ...
            <div class="column is-4">
              <div class="footer-group xs:pt-6">
                <slot name="column-3">
                  ...
                  <ul>
                    <li>
                      <RouterLink to="/about" class="level-item footer-link">
                        About us
                      </RouterLink>
                    </li>

                    <li>
                      <a href="/about#media" class="level-item footer-link">
                        In the media
                      </a>
                    </li>
                    <li>
                      <a
                        href="mailto://invest@sipstack.com"
                        class="level-item footer-link">
                        Investor Relations
                      </a>
                    </li>
    ...
    <div class="container copyright pt-10">
      <div class="columns">
        <div class="column is-4 has-text-left has-text-centered-mobile">
          <span class="footer-text-sub rem-90">
            SIPSTACK is a registered trademark of SIPSTACK Inc.
          </span>
        </div>
        ...
        <div class="column is-8 has-text-right has-text-centered-mobile">
          <span class="footer-text rem-90">
            <span id="footer-link-legal">
              <a href="/legal/tos" class="footer-link pr-10">
                Terms of Service
              </a>
              <!-- <a href="/legal/aup" class="footer-link pr-10">Acceptable Use Policy</a> -->
              <a href="/legal/privacy" class="footer-link pr-10">
                Privacy Policy
              </a>
              <a href="/legal/cookie" class="footer-link pr-10">
                Cookie Policy
              </a>
            </span>
          </span>

...
<template>
	<div class="py-6">
		<div class="founders-section">
			<div class="founders-section-inner" :class="props.limit && `is-${props.limit}`">
				<div v-for="(founder, index) in props.founders.slice(0, props.limit)" :key="index" class="founder">
					<img :src="founder.photo" alt="Founder photo" width="270" height="333" @error.once="(event) => viaPlaceholderErrorHandler(event, '270x333')" />
					...
					<div class="is-flex is-justify-content-center pt-3">
						<RouterLink v-for="(link, i) in founder.socialLinks" :key="i" :to="link.url" target="_blank" class="px-2">

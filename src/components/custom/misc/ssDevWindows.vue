    ...
    <div class="dev-windows">
      <div class="columns">
        <div class="column is-7">
          ...
          <SsTimelineBashWindow
            title="Bash"
            command="curl https://api.sipstack.com/v1/b/partner/smart-cnam/phoneNumber/14164772004"></SsTimelineBashWindow>
          <!--#endregion -->
          ...
          <div class="code-window is-second">
            <div class="window-head">
              ...
              <div class="address-bar">
                <span class="address">whois.sipstack.com</span>
            ...
            <div class="window-body">
              ...
              <div class="fake-body">
                <div class="left">
                  <div class="fake-img">
                    <DarkImage
                      src="/assets/img/telair-icon.png"
                      alt="product image" />
                  </div>
                </div>
                <div class="right">
        ...
        <div class="column is-4 is-offset-1">
          <div class="text-block max-w-4">
            ...
            <p class="paragraph">
              Integrate Smart CNAM into your system call flows and always
              receive the latest name information and call scores. Dynamic call
              scoring can return a 5 character spacing prefix to be handled or
              stripped on your inbound routes.
            </p>
          </div>
          <div class="text-block max-w-4">
            <Title tag="h2" :size="4" weight="bold" leading>
            ...
            <p class="paragraph">
              API calls can be used in a variety of mobile application for
              unique use cases. Provide your users with a rich experiences with
              Smart CNAM.
            </p>
          </div>
          <div class="text-block max-w-4">
            ...
            <p class="paragraph">
              Smart CNAM can be used in a wide range of applications. See
              Solutions for more details and industry specific use cases.
            </p>
          </div>
          <div class="text-block max-w-4">
            <Title tag="h2" :size="4" weight="bold" leading>
            ...
            <p class="paragraph">
              Whois by SIPSTACK is powered by the same powerful API that Smart
              CNAM offers, generating rich unique experiences on both web
              browsers and mobile. Increase the Whois score rating for your
              customers as well as earn a verified check badge and secure
              remarks when you add their numbers to your partner portal.
            </p>
          </div>
        </div>
        <!--#endregion -->
